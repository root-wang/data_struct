...
// root长为2*num-1;
void creat_huffman_tree(Huffman_tree_node *&tree,
                        int *&the_weight,
                        int num)
{
  for (int i = 0; i != num; ++i)
  ...
  for (int i = 0; i != num - 1; ++i)
  {
    ...
    tree[num + i].m_weight = tree[min1_index].m_weight + tree[min2_index].m_weight;
